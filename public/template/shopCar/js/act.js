define(function(){
    class clickDOM{
        ...
        P_M(){
            var that = this;
            $(".car .listBody ul li.count").children("s,b").click(function(e){
                that.getCookie();
                // goodsId
        ...
        checkBox(){
            var that = this;
            $(".car .listBody ul li:first-child input").click(function(){
                that.count();
                that.watchCheck();
            });
        };
        // 全选框
        allCheck(){
            var oInput = $(".car .listBody ul li:first-child input");
            var that = this;
        ...
        del(){
            var that = this;
            this.getCookie();
            $(".car .listBody ul li:last-child em").click(function(){
                // goodsId
                var id = $(this).parents("ul").find("img").attr("alt");
                that.removeAll(id,$(this));
                that.count();
        ...
        delAll(){
            var oInput = $(".car .listBody ul li:first-child input");
            var that = this;
            $(".car .listFoot li:nth-child(2) del").click(function(){
        ...
        count(){
            ...
            $(".car .listFoot li i").html(str2);
            $(".car .listFoot li strong").html("¥" + str1.toFixed(1));
        };
        // 购物车连接显示个数
        shopCount(){
            var oInput = $(".car .listBody ul li:first-child input");
